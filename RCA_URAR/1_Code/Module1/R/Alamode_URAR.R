  ...
  function( ) {
   ...
   # projEnv$AlamodeInputDF[33,"Subj"] <- projEnv$MlsCompsDF[1,"CityStateZip"]
    ...
    for(i in 1:9) {
      ...
      print(paste("ide:",i))
      projEnv$AlamodeInputDF[10,toString(i)] <- projEnv$MlsCompsDF[i+1,"SaleConc2"]
      print(paste("idf:",i))
      ...
      projEnv$AlamodeInputDF[11,str_c(toString(i),"b")] <- round(projEnv$MlsCompsDF[i+1,"URAR_Date_Of_Sale"],digits=0)
      projEnv$AlamodeInputDF[12,toString(i)] <- str_c(projEnv$MlsCompsDF[i+1,"LocNBA"],";",projEnv$MlsCompsDF[i+1,"LocDsc"] )
      projEnv$AlamodeInputDF[12,str_c(toString(i),"b")] <- round(projEnv$MlsCompsDF[i+1,"URAR_Location"]  ,digits=0)
      ...
      projEnv$AlamodeInputDF[14,str_c(toString(i),"b")] <-  projEnv$MlsCompsDF[i+1,"URAR_Site"]
      projEnv$AlamodeInputDF[15,toString(i)] <- str_c(projEnv$MlsCompsDF[i+1,"ViewNBA"] )
      print(paste("ido:",i))
      projEnv$AlamodeInputDF[15,str_c(toString(i),"b")] <- round(projEnv$MlsCompsDF[i+1,"CQA_V"] * projEnv$MlsCompsDF[i+1,"URAR_CQA"] ,digits=0)
      print(paste("ido1:",i))
      ...
      print(paste("idp:",i))
        projEnv$AlamodeInputDF[16,str_c(toString(i),"b")] <- round( projEnv$MlsCompsDF[i+1,"CQA_D"] * projEnv$MlsCompsDF[i+1,"URAR_CQA"],digits=0)
      projEnv$AlamodeInputDF[17,toString(i)] <- projEnv$MlsCompsDF[i+1,"Qual"]
      print(paste("i: ",i))
      projEnv$AlamodeInputDF[17,str_c(toString(i),"b")] <- round(projEnv$MlsCompsDF[i+1,"CQA_Q"] * projEnv$MlsCompsDF[i+1,"URAR_CQA"],digits=0)
      projEnv$AlamodeInputDF[18,toString(i)] <- projEnv$MlsCompsDF[i+1,"Age"]
      projEnv$AlamodeInputDF[18,str_c(toString(i),"b")] <- round(projEnv$MlsCompsDF[i+1,"URAR_ActualAge"],digits=0)
      projEnv$AlamodeInputDF[19,toString(i)] <- projEnv$MlsCompsDF[i+1,"Cond"]
      projEnv$AlamodeInputDF[19,str_c(toString(i),"b")] <- round(projEnv$MlsCompsDF[i+1,"CQA_C"] * projEnv$MlsCompsDF[i+1,"URAR_CQA"],digits=0)
      ...
      projEnv$AlamodeInputDF[23,str_c(toString(i),"b")] <- round(projEnv$MlsCompsDF[i+1,"URAR_RoomCount"],digits=0)
      ...
      projEnv$AlamodeInputDF[27,str_c(toString(i),"b")] <- round(projEnv$MlsCompsDF[i+1,"CQA_FU"] * projEnv$MlsCompsDF[i+1,"URAR_CQA"],digits=0)
      ...
      projEnv$AlamodeInputDF[30,str_c(toString(i),"b")] <- round(projEnv$MlsCompsDF[i+1,"URAR_Garage"],digits=0)

      projEnv$AlamodeInputDF[33,toString(i)] <- projEnv$MlsCompsDF[i+1,"FrPlcNbr"]
      projEnv$AlamodeInputDF[33,str_c(toString(i),"b")] <- str_c( round(projEnv$MlsCompsDF[i+1,"URAR_FrPlcNbr"],digits=0)," Fireplace")

      projEnv$AlamodeInputDF[34,toString(i)] <- str_c("CQA",projEnv$MlsCompsDF[i+1,"CQA"],":$",round(projEnv$MlsCompsDF[i+1,"URAR_CQA"],digits=0))
      #projEnv$AlamodeInputDF[34,str_c(toString(i),"b")] <- round( projEnv$MlsCompsDF[i+1,"URAR_CQA"],digits=0)
